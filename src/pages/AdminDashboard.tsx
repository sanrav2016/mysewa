      ...
      <div id="controls" className={`bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-lg transform border-orange-200 dark:border-slate-600 sticky w-full top-0 z-50 transition-all ${stickyControls ? "rounded-none border-0 border-b-4 -mx-4 lg:-mx-8 w-[calc(100%_+_32px)] lg:w-[calc(100%_+_4rem)] px-4 lg:px-8 py-4" : "border-4 p-6"}`}>
        ...
        <div className={`flex gap-4 ${stickyControls ? "mb-3" : "mb-6"}`}>
          <button
            ...
            className={`flex items-center gap-2 rounded-xl font-medium transition-all duration-200 hover:scale-105 border-2 border-dashed ${stickyControls ? "px-3 py-2 text-sm" : "px-6 py-3"} ${activeTab === 'users'
          ...
          <button
            ...
            className={`flex items-center gap-2 rounded-xl font-medium transition-all duration-200 hover:scale-105 border-2 border-dashed ${stickyControls ? "px-3 py-2 text-sm" : "px-6 py-3"} ${activeTab === 'events'
                ? 'bg-gradient-to-r from-orange-400 to-red-500 text-white shadow-lg border-orange-300'
                : 'text-slate-700 dark:text-slate-300 hover:bg-orange-100 dark:hover:bg-slate-700 border-transparent hover:border-orange-200 dark:hover:border-slate-600'
              }`}
          >
      ...
      <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border-4 border-orange-200 dark:border-slate-600">
        ...
        {activeTab === 'users' && (
          <div className="space-y-6">
            ...
            {addUserMethod === 'csv' && (
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-slate-700 dark:to-slate-600 p-6 rounded-xl border-2 border-dashed border-blue-200 dark:border-slate-500">
                <div className="flex items-center justify-between mb-4">
                ...
                <tbody>
                  {filteredUsers.map((user) => (
                    <tr key={user.id} className="border-b border-dashed border-orange-100 dark:border-slate-700 hover:bg-orange-50 dark:hover:bg-slate-700/50">
                      ...
                      <td className="py-3 px-4">
                        <span className={`px-2 py-1 rounded-lg text-sm font-medium capitalize ${user.role === 'admin'
                ...
                <tbody>
                  {filteredEvents.map((event) => (
                    <tr key={event.id} className="border-b border-dashed border-orange-100 dark:border-slate-700 hover:bg-orange-50 dark:hover:bg-slate-700/50">
                      ...
                      <td className="py-3 px-4">
                        <span className={`px-2 py-1 rounded-lg text-sm font-medium capitalize ${event.status === 'published'
                            ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300'
                            : event.status === 'draft'
